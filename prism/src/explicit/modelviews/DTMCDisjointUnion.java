...
{
	private DTMC <Double> model1;
	private DTMC <Double> model2;
	...
	public DTMCDisjointUnion(final DTMC <Double> model1, final DTMC <Double> model2)
	{
		this.model1 = model1;
		this.model2 = model2;
	...
	public static DTMC <Double> union(final DTMC <Double>... models)
	{
		return union(Arrays.asList(models));
	}

	public static DTMC <Double> union(final Iterable<? extends DTMC <Double>> models)
	{
		return union(models.iterator());
	}

	public static DTMC <Double>union(final Iterator<? extends DTMC <Double>> models)
	{
		if (!models.hasNext()) {
			throw new IllegalArgumentException("at least one model expected");
		}
		DTMC <Double> union = models.next();
	...
	@Deprecated
	public static DTMC <Double> DTMCUnion(final DTMC<Double> model1, final DTMC<Double> model2, final Map<Integer, Integer> identify)
	{
