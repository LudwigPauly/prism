...
public class DTMCRestricted extends DTMCView
{
	...
	public DTMCRestricted(final DTMC <Double> model, final Iterable<Integer> states)
	{
		this(model, states, STANDARD_RESTRICTION);
	}

	public DTMCRestricted(final DTMC <Double> model, final Iterable<Integer> states, final Restriction restriction)
	{
		this(model, BitSetTools.asBitSet(states.iterator()), restriction);
	}

	public DTMCRestricted(final DTMC <Double> model, final BitSet states)
	{
		this(model, states, STANDARD_RESTRICTION);
	}

	public DTMCRestricted(final DTMC <Double> model, final IntPredicate states)
	{
		this(model, states, STANDARD_RESTRICTION);
	}

	public DTMCRestricted(final DTMC <Double> model, final IntPredicate states, final Restriction restriction)
	{
		this(model, BitSetTools.asBitSet(new IterableStateSet(states, model.getNumStates()).iterator()), restriction);
	}

	public DTMCRestricted(final DTMC <Double> model, final BitSet include, final Restriction restriction)
	{
	...
	public static BasicModelTransformation<DTMC<Double>, DTMCRestricted> transform(final DTMC<Double> model, final IntPredicate states)
	{
		return transform(model, BitSetTools.asBitSet(new IterableStateSet(states, model.getNumStates()).iterator()));
	}

	public static BasicModelTransformation<DTMC<Double>, DTMCRestricted> transform(final DTMC model, final BitSet states)
	{
		return transform(model, states, STANDARD_RESTRICTION);
	}

	public static BasicModelTransformation<DTMC<Double>, DTMCRestricted> transform(final DTMC model, final BitSet states, final Restriction restriction)
	{
