...
public class CTMCAlteredDistributions extends CTMCView
{
	 ...
	 */
	public CTMCAlteredDistributions(final CTMC<Double> model, final IntFunction<Iterator<Entry<Integer, Double>>> mapping)
	{
		this.model = model;
	...
	public Iterator<Entry<Integer, Double>> getTransitionsIterator(final int state)
	{
		...
		return Reducible.extend(transitions).filter(NON_ZERO);
	}
	...
	public static CTMCAlteredDistributions fixDeadlocks(final CTMC<Double> model)
	{
	...
	@Deprecated
	public static CTMCAlteredDistributions addSelfLoops(final CTMC<Double> model, final BitSet states)
	{
		return trapStates(model, states);
	}

	public static CTMCAlteredDistributions deadlockStates(final CTMC<Double> model, final BitSet states)
	{
	...
	public static CTMCAlteredDistributions trapStates(final CTMC<Double> model, final BitSet states)
	{
	...
	@Deprecated
	public static CTMC<Double> identifyStates(final CTMC<Double> model, final Iterable<BitSet> equivalenceClasses)
	{
		...
		final CTMC<Double> reattached = new CTMCAlteredDistributions(model, reattach);
		...
		final CTMC<Double> redirected = new CTMCAlteredDistributions(reattached, redirectDistribution);
