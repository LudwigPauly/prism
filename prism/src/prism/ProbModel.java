...
public class ProbModel implements Model
{
	...
	@Override
	public boolean hasLabelDD(String label)
	{
		return labelsDD.containsKey(label);
	}

	@Override
	public Set<String> getLabels()
	{
		return labelsDD.keySet();
	}
	...
	/**
	 * Compute the set of reachable states, where the parameter {@seed}
