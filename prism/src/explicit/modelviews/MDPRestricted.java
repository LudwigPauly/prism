...
public class MDPRestricted extends MDPView
{
	...
	public static BasicModelTransformation<MDP<Double>, MDPRestricted> transform(final MDP model, final IntPredicate states)
	{
		return transform(model, Reducible.unboxInt(new IterableStateSet(states, model.getNumStates())).collect(new BitSet()));
	}

	public static BasicModelTransformation<MDP<Double>, MDPRestricted> transform(final MDP model, final BitSet states)
	{
		return transform(model, states, STANDARD_RESTRICTION);
	}

	public static BasicModelTransformation<MDP<Double>, MDPRestricted> transform(final MDP model, final BitSet states, final Restriction restriction)
	{
