...
public class CTMCRestricted extends CTMCView
{
	...
	public CTMCRestricted(final CTMC<Double> model, final Iterable<Integer> states)
	{
		this(model, states, STANDARD_RESTRICTION);
	}

	public CTMCRestricted(final CTMC<Double> model, final Iterable<Integer> states, final Restriction restriction)
	{
		this(model, Reducible.unboxInt(states).collect(new BitSet()), restriction);
	}

	public CTMCRestricted(final CTMC<Double> model, final BitSet states)
	{
		this(model, states, STANDARD_RESTRICTION);
	}

	public CTMCRestricted(final CTMC<Double> model, final IntPredicate states)
	{
		this(model, states, STANDARD_RESTRICTION);
	}

	public CTMCRestricted(final CTMC<Double> model, final IntPredicate states, final Restriction restriction)
	{
		this(model, Reducible.unboxInt(new IterableStateSet(states, model.getNumStates())).collect(new BitSet()), restriction);
	}

	public CTMCRestricted(final CTMC<Double> model, final BitSet include, final Restriction restriction)
	{
	...
	public static BasicModelTransformation<CTMC<Double>, CTMCRestricted> transform(final CTMC<Double> model, final IntPredicate states)
	{
		return transform(model, Reducible.unboxInt(new IterableStateSet(states, model.getNumStates())).collect(new BitSet()));
	}

	public static BasicModelTransformation<CTMC<Double>, CTMCRestricted> transform(final CTMC <Double> model, final BitSet states)
	{
		return transform(model, states, STANDARD_RESTRICTION);
	}

	public static BasicModelTransformation<CTMC<Double>, CTMCRestricted> transform(final CTMC<Double> model, final BitSet states, final Restriction restriction)
	{
