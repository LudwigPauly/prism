...
public class DTMCAdditionalStates extends DTMCView
{
	...
	public DTMCAdditionalStates(final DTMC<Double> model, final int numStates)
	{
		this(model, numStates, true);
	}

	public DTMCAdditionalStates(final DTMC<Double> model, final int numStates, final boolean fill)
	{
		this.model = model;
	...
	public DTMCAdditionalStates(final DTMC<Double> model, final State ... states)
	{
		this(model, Arrays.asList(states));
	}

	public DTMCAdditionalStates(final DTMC<Double> model, final List<State> states)
	{
		this.model = model;
