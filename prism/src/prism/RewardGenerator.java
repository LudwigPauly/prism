...
public interface RewardGenerator
{
	 ...
	 */
	public default List<String> getRewardStructNames() throws PrismException
	{
	 ...
	 */
	public default int getNumRewardStructs() throws PrismException
	{
	 ...
	 */
	public default int getRewardStructIndex(String name) throws PrismException
	{
		// Default implementation just extracts from getRewardStructNames()
	 ...
	 */
	public default String getRewardStructName(int i) throws PrismException
	{
		// Default implementation just extracts from getRewardStructNames()
